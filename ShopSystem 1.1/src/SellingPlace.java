public class SellingPlace extends Place{
    ...
    public SellingPlace(String name,Employee employee,Product[] product_list){
        this.name = name;
        this.employee = employee;
        this.product_list = product_list;
        this.sellingAmount = 0;
    }
    public SellingPlace(String name,Product[] product_list){
        this.name = name;
        this.employee = employee;
        this.product_list = product_list;
        this.sellingAmount = 0;
    ...
    public void Sell(int index,int amount){
        ...
        int currentAmount = product_list[index].getAmount();
        if(amount == currentAmount){
            remove(index);
        }else{
            product_list[index].setAmount(currentAmount-amount);
        }
    }
    @Override
